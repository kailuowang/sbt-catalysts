...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "3.5.1", org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "cats-mtl",         version = "1.3.1",  org = typeLevelOrg, "cats-mtl", "cats-mtl-laws")
    ...
    .add(name = "fs2" ,             version = "3.9.2",  org = "co.fs2", modules = "fs2-core")
    .addJVM(name = "fs2-jvm" ,      version = "3.9.2",  org = "co.fs2", "fs2-reactive-streams", "fs2-io")
    .addJVM(name = "fs2-kafka",     version = "3.0.1",  org = "com.github.fd4s")
    .addJVM(name = "http4s" ,       version = "0.23.23", org = "org.http4s", modules = "http4s-dsl",  "http4s-circe", "http4s-core")
    ...
    .add(name = "specs2",           version = "4.20.2",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
