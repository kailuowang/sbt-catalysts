...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "3.4.8", org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "cats-mtl",         version = "1.3.0",  org = typeLevelOrg, "cats-mtl", "cats-mtl-laws")
    ...
    .add(name = "fs2" ,             version = "3.6.1",  org = "co.fs2", modules = "fs2-core")
    .addJVM(name = "fs2-jvm" ,      version = "3.6.1",  org = "co.fs2", "fs2-reactive-streams", "fs2-io")
    .addJVM(name = "fs2-kafka",     version = "2.4.0",  org = "com.github.fd4s")
    .addJVM(name = "http4s" ,       version = "0.23.18", org = "org.http4s", modules = "http4s-dsl",  "http4s-circe", "http4s-core")
    .addJVM(name = "http4s-modules" ,       version = "0.23.14", org = "org.http4s", modules =  "http4s-play-json",  "http4s-twirl", "http4s-blaze-client", "http4s-blaze-server")
    ...
    .addJVM( name = "pureconfig",      version = "0.17.2", org = "com.github.pureconfig", "pureconfig-cats-effect", "pureconfig-generic")
    .add(name = "refined",          version = "0.10.2",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
    .add(name = "scalacheck",       version = "1.17.0", org = "org.scalacheck")
    .add(name = "scalatest",        version = "3.2.15",  org = "org.scalatest")
    ...
    .add(name = "specs2",           version = "4.19.2",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
    .add(name = "scalac"   ,        version = "2.13.10")
    .add(name = "scalac_2.13",      version = "2.13.10")
