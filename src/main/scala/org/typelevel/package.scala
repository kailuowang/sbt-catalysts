...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-collections", version = "0.9.6",  org = typeLevelOrg, "cats-collections-core")
    ...
    .add(name = "fs2" ,             version = "3.7.0",  org = "co.fs2", modules = "fs2-core")
    .addJVM(name = "fs2-jvm" ,      version = "3.7.0",  org = "co.fs2", "fs2-reactive-streams", "fs2-io")
    .addJVM(name = "fs2-kafka",     version = "3.0.1",  org = "com.github.fd4s")
    .addJVM(name = "http4s" ,       version = "0.23.22", org = "org.http4s", modules = "http4s-dsl",  "http4s-circe", "http4s-core")
    ...
    .add(name = "scalatest",        version = "3.2.16",  org = "org.scalatest")
    ...
    .add(name = "specs2",           version = "4.20.0",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
    .add(name = "scalac"   ,        version = "2.13.11")
    .add(name = "scalac_2.13",      version = "2.13.11")
