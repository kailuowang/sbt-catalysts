...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-tagless",     version = "0.16.2",    org = typeLevelOrg, "cats-tagless-core", "cats-tagless-laws", "cats-tagless-macros")
    ...
    .addJVM(name = "http4s" ,       version = "0.23.28", org = "org.http4s", modules = "http4s-dsl",  "http4s-circe", "http4s-core")
