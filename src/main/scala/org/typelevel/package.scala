...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .addJVM(name = "http4s" ,       version = "0.23.13", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe", "http4s-twirl", "http4s-core")
