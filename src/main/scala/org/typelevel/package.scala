...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "3.4.2", org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    .add(name = "cats-effect-testing",  version = "1.5.0",  org = typeLevelOrg, modules="cats-effect-testing-scalatest", "cats-effect-testing-utest", "cats-effect-testing-minitest")
    ...
    .add(name = "fs2" ,             version = "3.4.0",  org = "co.fs2", modules = "fs2-core")
    .addJVM(name = "fs2-jvm" ,      version = "3.4.0",  org = "co.fs2", "fs2-reactive-streams", "fs2-io")
    .addJVM(name = "fs2-kafka",     version = "2.4.0",  org = "com.github.fd4s")
    .addJVM(name = "http4s" ,       version = "0.23.16", org = "org.http4s", modules = "http4s-dsl",  "http4s-circe", "http4s-core")
    ...
    .add(name = "refined",          version = "0.10.1",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
    .add(name = "scalacheck",       version = "1.17.0", org = "org.scalacheck")
    .add(name = "scalatest",        version = "3.2.13",  org = "org.scalatest")
    ...
    .add(name = "specs2",           version = "4.19.0",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
