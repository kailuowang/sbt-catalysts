...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-collections", version = "0.9.4",  org = typeLevelOrg, "cats-collections-core")
    .add(name = "cats-effect",      version = "3.3.14", org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "specs2",           version = "4.16.1",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
