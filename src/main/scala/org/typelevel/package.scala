...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "specs2",           version = "4.20.8",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
    .add(name = "scalac"   ,        version = "2.13.14")
    .add(name = "scalac_2.13",      version = "2.13.14")
