...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "fs2" ,             version = "3.2.14",  org = "co.fs2", modules = "fs2-core")
    .addJVM(name = "fs2-jvm" ,      version = "3.2.14",  org = "co.fs2", "fs2-reactive-streams", "fs2-io")
    .addJVM(name = "fs2-kafka",     version = "2.4.0",  org = "com.github.fd4s")
    .addJVM(name = "http4s" ,       version = "0.23.15", org = "org.http4s", modules = "http4s-dsl",  "http4s-circe", "http4s-core")
    ...
    .add(name = "scalacheck",       version = "1.16.0", org = "org.scalacheck")
