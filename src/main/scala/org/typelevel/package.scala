...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "3.3.12", org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "fs2" ,             version = "3.2.7",  org = "co.fs2", modules = "fs2-core")
    .addJVM(name = "fs2-jvm" ,      version = "3.2.7",  org = "co.fs2", "fs2-reactive-streams", "fs2-io")
    ...
    .add(name = "refined",          version = "0.9.29",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
