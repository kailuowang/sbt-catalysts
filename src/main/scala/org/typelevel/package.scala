...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "3.5.2", org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "fs2" ,             version = "3.9.3",  org = "co.fs2", modules = "fs2-core")
    .addJVM(name = "fs2-jvm" ,      version = "3.9.3",  org = "co.fs2", "fs2-reactive-streams", "fs2-io")
    .addJVM(name = "fs2-kafka",     version = "3.2.0",  org = "com.github.fd4s")
    .addJVM(name = "http4s" ,       version = "0.23.24", org = "org.http4s", modules = "http4s-dsl",  "http4s-circe", "http4s-core")
    .addJVM(name = "http4s-modules" ,       version = "0.23.15", org = "org.http4s", modules =  "http4s-play-json",  "http4s-twirl", "http4s-blaze-client", "http4s-blaze-server")
    .add(   name = "jawn",          version = "1.5.1",  org = org.typelevel.typeLevelOrg, "jawn-ast", "jawn-parser", "jawn-util")
    .add(name = "kittens",          version = "3.1.0",  org = typeLevelOrg)
    ...
    .add(name = "specs2",           version = "4.20.3",  org = "org.specs2", "specs2-core", "specs2-scalacheck", "specs2-mock")
