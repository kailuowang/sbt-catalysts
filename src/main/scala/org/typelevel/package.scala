...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect-testing",  version = "1.6.0",  org = typeLevelOrg, modules="cats-effect-testing-scalatest", "cats-effect-testing-utest", "cats-effect-testing-minitest")
