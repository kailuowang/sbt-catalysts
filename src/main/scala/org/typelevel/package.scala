...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "3.5.0", org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .addJVM(name = "http4s" ,       version = "0.23.20", org = "org.http4s", modules = "http4s-dsl",  "http4s-circe", "http4s-core")
    ...
    .add(name = "refined",          version = "0.10.3",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
