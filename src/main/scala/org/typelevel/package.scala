...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "3.4.5", org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .addJVM(name = "http4s" ,       version = "0.23.17", org = "org.http4s", modules = "http4s-dsl",  "http4s-circe", "http4s-core")
