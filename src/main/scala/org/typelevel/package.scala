...
object `package` {
  ...
  val libraries = Libraries()
    ...
    .add(name = "cats-effect",      version = "3.3.13", org = typeLevelOrg, "cats-effect", "cats-effect-laws")
    ...
    .add(name = "fs2" ,             version = "3.2.9",  org = "co.fs2", modules = "fs2-core")
    .addJVM(name = "fs2-jvm" ,      version = "3.2.9",  org = "co.fs2", "fs2-reactive-streams", "fs2-io")
    .addJVM(name = "fs2-kafka",     version = "2.5.0",  org = "com.github.fd4s")
    .addJVM(name = "http4s" ,       version = "0.23.11", org = "org.http4s", modules = "http4s-dsl", "http4s-blaze-server", "http4s-blaze-client", "http4s-play-json", "http4s-circe", "http4s-twirl", "http4s-core")
    ...
    .add(name = "refined",          version = "0.10.0",  org = "eu.timepit", "refined", "refined-scalacheck", "refined-scodec")
    .add(name = "scalacheck",       version = "1.16.0", org = "org.scalacheck")
    .add(name = "scalatest",        version = "3.2.12",  org = "org.scalatest")
